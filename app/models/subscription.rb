class Subscription < ActiveRecord::Base
  ...
  def self.send_reminder_emails
    ...
    @notified_users.push {:two_week_subs => @two_week_subs}
    ...
    @notified_users.push {:one_week_subs => @one_week_subs}
    ...
    @notified_users.push {:two_day_subs => @two_day_subs}
    ...
    @notified_users.push {:one_week_trials => @one_week_trials}
    ...
    @notified_users.push {:three_day_trials => @three_day_trials}
    ...
    @notified_users.push {:expired_trials => @expired_trials}
  end
